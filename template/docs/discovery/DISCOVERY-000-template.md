...
<Proportionate competitor/market check. How others solve this; table-stakes vs differentiator vs anti-pattern. Cite sources (URLs).>

## Reasons NOT to build (mandatory — anti-hype)

- **Cheaper alternative:** …
- **Do-nothing:** what happens if we ship nothing here …
- **Bad-use-of-time test:** why this could be the wrong thing for a solo founder to spend on now …

## Recommended requirement shape (for gate 1)

<The option to carry into gate 1 and why the others lose — grounded, no cheerleading. This is a recommendation gate 1 is free to reject. List the open questions gate 1 should resolve into ACs.>
