...
3. Write `docs/requirements/BR-<next>-<slug>.md` from BR-000-template.md. **Numbered Given/When/Then acceptance criteria are mandatory** — gate 2 bounces BRs without them. Include out-of-scope, KPI impact, dependencies. Number by scanning existing BRs.
