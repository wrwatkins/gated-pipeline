...
Project rule file (ADR-014; formerly `the project's earlier instructions file` §PR workflow). Unconditional — loads every session.
...
- Approvals may use a bot-based approval flow if your project configures one (optional).
