...
- Shared interaction helpers required (`apps/web/e2e/helpers.ts`); adopt Page Object Model at scale, ~40+ tests (supersedes the earlier blanket POM mandate — DEBT C4-r resolution; the shipped 8-spec suite is functional-helpers and healthy).
- Retries: `0` everywhere; a flaky test is a FAIL (supersedes the earlier 2-in-CI guidance; DEBT C4 resolution).
