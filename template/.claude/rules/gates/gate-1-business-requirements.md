...
2. Challenge it before writing. FAIL (with reasons and a sharper alternative) if it conflicts with: trust guardrails (max your product guardrails (STACK.md); data leaves only on explicit click), PADU, roadmap scope discipline, or your project's accuracy bar (STACK.md).
